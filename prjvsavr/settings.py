"""
Django settings for prjvsavr project.
...
# SECRET_KEY = 'django-insecure-3$t3*nf0o2id6mdvpk$6qjaob*&=u1i*2twq%4pu0^s&p*^4^0'
...
WSGI_APPLICATION = 'prjvsavr.wsgi.application'
